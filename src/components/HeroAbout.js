...
// import data
import { heroabout } from "../data";

// import components
import Stats from "./Stats";

const Hero = () => {
  const { title, subtitle, buttonText } = heroabout;
  return (
    <section className="h-full max-h-[850px] w-full bg-heroabout bg-center lg:bg-center bg-cover bg-no-repeat text-white pt-[225px] pb-[254px] relative mb-12 lg:mb-28">
